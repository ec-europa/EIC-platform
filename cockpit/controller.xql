...
declare variable $actions := <actions error="models/error.xql">
  ...
  <action name="welcome" depth="0" epilogue="home">
    <model src="models/login.xql"/>
    <view src="views/login.xsl"/>
  </action>
  <action name="logout" depth="0" epilogue="home">
    <model src="models/logout.xql"/>
    <view src="views/logout.xsl"/>
  </action>
...
let $mapping := fn:doc('/db/www/cockpit/config/mapping.xml')/site
