...
(: ======================================================================
   ...
   ====================================================================== 
:)
declare function drupal:do-bootstrap($enterprise as element(), $lang as xs:string) as element()?
{
  let $payload := community:gen-bootstrap-payload($enterprise, $lang)
  return
...
(: ======================================================================
   ...
   ====================================================================== 
:)
declare function drupal:do-update-organisation($enterprise as element(), $lang as xs:string) as element()?
{
  let $payload := community:gen-bootstrap-payload($enterprise, $lang)
  return
    let $res := drupal:put-to-service('community', 'bootstrap', $payload, "200", concat('/', $enterprise/Id/text()))
    return
      $res
};
