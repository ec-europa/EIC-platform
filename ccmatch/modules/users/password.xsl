...
<!-- CCMATCH - EIC Coach Match Application
    ...
    TODO:
    - parameterize generated URLs in model (for returning home or continuing after password change)
            ...
            <form class="form-horizontal" action="{Controller}" method="post">
              ...
              <div class="control-group" id="submit">
                <div class="controls">
                  ...
                  <a class="btn" href="../login" loc="action.cancel">Annuler</a>
                </div>
              </div>
            </fieldset>
          </form>
            ...
            <form class="form-horizontal" action="{Controller}" method="post">
              ...
              <div class="control-group" id="submit">
                <div class="controls">
                  ...
                  <a class="btn" href="{Username}" loc="action.cancel">Annuler</a>
                </div>
              </div>
            </fieldset>
          </form>
    ...
    <site:content>
        <div class="row login" style="margin-top: 2em">
          <div class="span7 offset3">
            ...
            <p class="text-right"><a href="../login" class="btn" loc="action.back">Retour</a></p>
          </div>
        </div>
    </site:content>
  </xsl:template>
    ...
    <site:content>
        <div class="row login">
          <div class="span7 offset3">
            ...
            <p class="text-right"><a href="{Username}" class="btn" loc="action.continue">Continuer</a></p>
          </div>
        </div>
    </site:content>
  </xsl:template>
