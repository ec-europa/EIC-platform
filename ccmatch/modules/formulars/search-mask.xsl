...
<!--
     ...
     August 2014 - European Union Public Licence EUPL
  -->
...
<xsl:stylesheet version="1.0"
  ...
  <xsl:param name="xslt.base-formulars">webapp/projects/ccmatch/formulars/</xsl:param>
  ...
  <xsl:template  match="Criteria">
    ...
    <td>
      ...
      <xsl:apply-templates select="ancestor::Form/Ornamentations/*[contains(@Keys, $key)]">
  ...
  <xsl:template match="Expertise">
    <xsl:param name="tag">Tag</xsl:param>
    <br/>
    <p class="ornamentation">
    Expertise level : 
    <xt:use label="Expertise-{$tag}" types="choice" param="appearance=full;multiple=no;class=c-inline-choice" values="mid high" i18n="mid\ or\ high high\ only">high</xt:use>
    </p>
  </xsl:template>
