...
declare function email:render-email( 
  ...
  $extras as element()* ) as element() 
{
  media:render-email($name, email:gen-variables-for($name, $lang, $project, $case, $activity, $extras), $lang)
};
...
declare function email:render-alert( 
  ...
  $extras as element()* ) as element() 
{
  media:render-alert($name, email:gen-variables-for($name, $lang, $project, $case, $activity, $extras), $lang)
};
...
{
  media:render-alert($name, email:gen-variables-for($name, $lang, $project, $case, $activity, ()), $lang)
};
