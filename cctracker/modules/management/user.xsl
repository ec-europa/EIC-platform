  ...
  <xsl:template match="/Persons">
    <div id="results">
      ...
      <div style="margin:2em 0 0.5em 0">
        <div id="results-export" style="float:right">
      ...
      <table name="users" class="table table-bordered fixed" style="font-size:8pt">
        <thead>
          <tr>
            <th style="width:180px">Name <span style="font-weight:normal;display:block"><input style="width:170px" id="user-filter"/></span></th>
