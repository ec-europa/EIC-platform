...
echo "xmldb:chmod-collection('/db/www/cctracker/config', util:base-to-integer(0775, 8))" | ../../../../bin/client.sh -u admin -P $1 -x 
echo "xmldb:chmod-collection('/db/www/cctracker/mesh', util:base-to-integer(0775, 8))" | ../../../../bin/client.sh -u admin -P $1 -x 
...
let $targets := ( '/www/cctracker/config', '/www/cctracker/mesh' )
return 
